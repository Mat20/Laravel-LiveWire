<div>
   <h1 class="text-4xl py-6 font-bold">Atualizar Foto Perfil</h1> <br>

   <form action="#" method="post" wire:submit.prevent="storagePhoto" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-8 m-8">
      @if ($photo)
            <div class="mb-4">
